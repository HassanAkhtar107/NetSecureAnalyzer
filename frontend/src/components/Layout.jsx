...
const Layout = ({ children, userType, onLogout }) => {
  ...
  const menuItems = [
    ...
    { name: 'Data Transfer', icon, path: '/transfers' },
    { name: 'Firewall', icon, path: '/firewall' },
    { name: 'VPN', icon, path: '/vpn' },
    { name: 'Topology', icon, path: '/topology' },
    { name: 'Reports', icon, path: '/performance' },
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center mb-4">
                <div className="relative w-20 h-20">
                  ...
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 4, repeat, ease: "linear" }}
