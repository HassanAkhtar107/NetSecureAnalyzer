...
export default function DashboardPage() {
  ...
  const statCards = [
    { label: "Download", value: stats.download, suffix: " Mbps", decimals: 1, icon, color: "text-primary" },
    { label: "Upload", value: stats.upload, suffix: " Mbps", decimals: 1, icon, color: "text-neon-green" },
    { label: "Ping", value: stats.ping, suffix: " ms", decimals: 0, icon, color: "text-neon-blue" },
    { label: "Jitter", value: stats.jitter, suffix: " ms", decimals: 0, icon, color: "text-neon-yellow" },
    { label: "Packet Loss", value: stats.packetLoss, suffix: "%", decimals: 2, icon, color: "text-neon-red" },
  ];
