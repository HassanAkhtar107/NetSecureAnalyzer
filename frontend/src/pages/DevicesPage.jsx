...
const statusConfig = {
  active: { label: "Active", icon, color: "text-neon-green", bg: "bg-neon-green/10" },
  blocked: { label: "Blocked", icon, color: "text-destructive", bg: "bg-destructive/10" },
  pending: { label: "Pending", icon, color: "text-neon-yellow", bg: "bg-neon-yellow/10" },
};
